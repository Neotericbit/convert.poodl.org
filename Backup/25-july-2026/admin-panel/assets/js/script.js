...
$(document).ready(function(){
   ...
   if (typeof window.ethereum !== 'undefined') {
    ...
    async function init(){
        ...
        rewardFundAmt =  Number(rewardFundAmt) / Math.pow(10, decimals)
        rewardFundAmt = rewardFundAmt.toFixed(7);

        $("#availReward").html(rewardFundAmt + " Poodl")
        //alert(rewardFundAmt);
        ...
        $("#availComm").html(commissionFundAmt + " Poodl")
        ...
        $("#availGift").html(giftFundAmt + " Poodl")
        //alert(giftFundAmt);
        ...
        $('.addfund').click(async function(){
            ...
            try {
              //await processTx( PoodlReferralContractAddress, memberShipRefCodeABI, config.method, Array(), payableAmount, explorerURL );
               ...
               //alertify.alert("Warning", "Transaction Failed");
            }
        });
